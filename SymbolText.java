...
public class SymbolText extends SymbolElement
{
  ...
  public String toString(long xOffset, long yOffset, String format) {
    return ""; // can populate this for xschem potentially
  }
  ...
  public static String symDefAttributeString(long xOffset, long yOffset, String attribute) {
    String extract = "";
    if (attribute.startsWith("! ")) {
      extract = attribute.substring(2);
    } else {
      extract = attribute;
    }
  ...
  public static String BXLAttributeString(long xOffset, long yOffset, String attribute) {
    ...
    if (attribute.startsWith("refdes=") ||
        ...
        attribute.startsWith("documentation=") ||
        attribute.startsWith("copyright=") ||
        attribute.startsWith("uselicence=") ||
        attribute.startsWith("distlicence=") ||
        attribute.startsWith("author=")) {
      extract = attribute;
    } else {
